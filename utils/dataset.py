...
class NerDataset(Dataset):
    def __init__(self, f_path, cfg, gold_tag, seg_tag, task = 'OIE'):
        ...
        for entry in entries:
            ...
            seg_tags = ['O' for line in entry.splitlines()]
            if(self.seg_tag == True):
                seg_tags = [line.split('\t')[2] for line in entry.splitlines()]
                #tags =  [line.split('\t')[2] for line in entry.splitlines()]
